...
import {
  ...
  listPictureVoByPageUsingPost, reviewPictureUsingPost
...
const handleReview = async (record: API.Picture, reviewStatus: number) => {
  const reviewMessage = reviewStatus === PIC_REVIEW_STATUS_ENUM.PASS ? '管理员已通过该审核' : '管理员已拒绝该审核'
